 ...
 */
 ...
 (function($){
	...
	$.fn.tablePagination = function(settings) {
		var defaults = {  
			firstArrow : (new Image()).src="./img/utilization/first.gif",  
			prevArrow : (new Image()).src="./img/utilization/prev.gif",
			lastArrow : (new Image()).src="./img/utilization/last.gif",
			nextArrow : (new Image()).src="./img/utilization/next.gif",
			rowsPerPage : 5,
			currPage : 1,
      ...
      $(table)[tblLocation]().find(rowsPerPageId).bind('change', function (e) {
      	...
      	var ddd = parseInt(this.value, 10);
        defaults.rowsPerPage = ddd + 2;
