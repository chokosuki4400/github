...
if ($ticket === $save) {
	...
	if($l_user){
		// $to = 'wmd@ejworks.com'; 本番用メールアドレス
		$to = 'y.ohnishi@ejworks.com'; //デバック用メールアドレス
		$subject = '【TESTKASHIDASH】'. $item .'貸出中';
		...
		$from = mb_encode_mimeheader(mb_convert_encoding('KASHIDASH','JIS','UTF8')).'<y.ohnishi@ejworks.com>';
